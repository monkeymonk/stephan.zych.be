...
- **Is it public or private?** A generic `starship` config is public. Your git signing key, your client's API token, your real monitor layout with its hostname in it are private.
...
Once you've drawn these boundaries, you start noticing squatters. Things living in your "dotfiles" that aren't configuration *or* provisioning *or* secrets are **tools** that just happened to grow up there.
