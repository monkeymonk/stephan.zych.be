...
- A public **WordPress** site presenting the programme and selling the set
- The connected classroom application at `app.amagirafe.org` driving the exchanges
- A design and component system aimed at teachers and children, not developers
