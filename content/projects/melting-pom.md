---
layout: project.njk
title: "Melting Pom: Fruit baskets and gift hampers, B2B and B2C"
...
One storefront, two audiences. Corporate buyers ordering in volume and individuals buying a single gift expect different things from the same catalogue, and every basket can be personalised, so the product model had to stay flexible without becoming confusing.

## What we built

Delivered at Cherry Pulp on a custom **WordPress** foundation:

- A bespoke theme and product presentation for personalisable fruit and gift baskets
