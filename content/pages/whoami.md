...
```text
STEPHAN(1)                   User Commands                   STEPHAN(1)
```

## NAME

**stephan** — lead developer, frontend architect, recovering CTO

## SYNOPSIS

`stephan [--architecture] [--tooling] [--strong-opinions] [PROJECT...]`
...
Brussels, Belgium. `LANG=fr_BE` (native), `LC_MESSAGES=en` (professional). Runs on coffee and a Docker homelab.
